...
**Latest commit:** see the tip of this branch — the §16.4 A/B round (`95dfff8`), the §16.3a bullet-2 shell/tooling tasks, and the §4.7/§4.9 Hermes tool-call format on top of them
...
**Test suite (locally):** 854/854 passing, 86 test files, clean `tsc -b`, clean
